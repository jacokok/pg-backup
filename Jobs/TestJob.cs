...
public class TestJob : IJob
{
    ...
    public TestJob(ILogger<TestJob> logger, IOptions<DBConfig> config)
    {
        _logger = logger;
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        // Save to file
        // using var sw = new StreamWriter(@"backup.dump");
        // await sw.WriteAsync(backup);
